...
STA         APU_SND_NOISE
LDA         #$0
STA         APU_SND_TRIANGLE
STA         APU_SND_TRIANGLE_A
STA         APU_SND_TRIANGLE_B
RTS
...
TAY
LDA         DAT_fd4f,Y                              ;= AEh
STA         APU_SND_SQUARE1_2,X
STA         $01c2,X                          ;= ??
LDA         DAT_fd4e,Y                              ;= 06h
CMP         $01c3,X                          ;= ??
BEQ         FUN_f537
STA         APU_SND_SQUARE1_3,X
STA         $01c3,X                          ;= ??
JMP         FUN_f537
...
STA         APU_SND_SQUARE1
LDA         #$7f
STA         APU_SND_SQUARE1_1
LDA         $fc2e,X
SEC
SBC         $00c0                            ;= ??
STA         APU_SND_SQUARE1_2
LDA         $100,X
SBC         #$0
CMP         $01c3                            ;= ??
BEQ         LAB_APU_SND_TRIANGLE_REG_fb3e
STA         APU_SND_SQUARE1_3
STA         $01c3                            ;= ??
...
LDA         $005f                            ;= ??
BNE         LAB_APU_NOISE_REG_APU_NOISE_REG_FREQUENCY
RTS
LAB_APU_NOISE_REG_APU_NOISE_REG_FREQUENCY:;XREF[1,0]:   fbf1
LDA         $01c3                            ;= ??
STA         APU_SND_SQUARE1_3
LDA         $01cb                            ;= ??
STA         APU_SND_TRIANGLE_B
...
STA         APU_SND_NOISE
LDA         #$e
STA         APU_SND_NOISE_FREQUENCY_2
LDA         #$88
STA         APU_SND_NOISE_FREQUENCY_AND_TIME_3
LDA         #$7
JSR         FUN_f48e                                ;undefined FUN_f48e()
RTS
;************************************************************************************************
